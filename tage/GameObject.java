...
public class GameObject
{
	...
	*/
	...
	public void straightMovement(float moveSpeed)
	{
		Vector4f direction = new Vector4f(0f,0f,1f,1f);
		Vector3f oldPosition = getWorldLocation();
		direction.mul(getWorldRotation());
		direction.mul(moveSpeed);
		Vector3f newPosition = oldPosition.add(direction.x(),
