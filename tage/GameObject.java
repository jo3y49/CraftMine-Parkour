...
public class GameObject
{
	...
	*/
	...
	public void Pitch(Float elapsTime){
		...
		Matrix4f rotAroundAvatarUp = new Matrix4f().rotation(elapsTime, new Vector3f(oldUp.x(), oldUp.y(), oldUp.z())); 
	...
	public void zMove(Float elapsTime){
		Vector3f oldPosition = this.getWorldLocation(); 
