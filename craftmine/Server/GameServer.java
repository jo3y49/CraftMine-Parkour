...
public class GameServer  extends GameConnectionServer<UUID> {
    ...
    public GameServer (int localPort, NPCcontroller npc) throws IOException{
    ...
    public void processPacket(Object o, InetAddress senderIP, int port){
        ...
        clientMessages(strMessage, messageTokens, senderIP, port);
        aiMessages(strMessage, messageTokens, senderIP, port);
    }

    private void clientMessages(String strMessage, String[] messageTokens, InetAddress senderIP, int port){
    ...
    private void aiMessages(String strMessage, String[] messageTokens, InetAddress senderIP, int port){
